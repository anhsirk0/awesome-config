...
-- For changing themes
local chosen_theme = "ef-trio-dark"
local colors                    = require("themes." .. chosen_theme .. ".colors")

local theme                     = colors
-- theme.font                      = "Aporetic Sans Mono Medium 11"
theme.font                      = "Iosevka Term SS04 Medium 12"
-- theme.font                      = "iA Writer Mono S 10"
theme.taglist_font              = theme.font
-- theme.taglist_font              = "awesomewm-font 13"

theme.notification_font         = "Aporetic Sans Mono 19"
...
function theme.at_screen_connect(s)
   if theme.wallpaper:match("^#") and bling then
      -- local symbol = "♥"
      -- local symbol = "✿"
      -- local symbol = "⚝"
      local symbol = "⚝"
      bling.module.tiled_wallpaper(symbol, s, {
        ...
        font = "FreeSerif",  -- set the font (without the size)
