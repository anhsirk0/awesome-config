...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/red-line"
...
-- awful.util.tagnames   = { "ƀ", "Ƅ", "Ƌ", "ƈ", "ƙ", "ƛ"}
-- awful.util.tagnames   = { "ƌ", "Ɯ", "Ҽ", "Ṩ", "Ѻ", "Ϻ", "Ɛ"}
...
local arrl_pre  = separators.arrow_left("alpha", theme.accent)
local orange_arrl_pre  = separators.arrow_left("alpha", theme.orange)
local pink_arrl_pre  = separators.arrow_left("alpha", theme.pink)
local red_arrl_pre  = separators.arrow_left("alpha", theme.pink)
local arrl_post = separators.arrow_left(theme.accent, "alpha")
local orange_arrl_post = separators.arrow_left(theme.orange, theme.pink)
local pink_arrl_post = separators.arrow_left(theme.pink, theme.red)
local red_arrl_post = separators.arrow_left(theme.red, theme.red)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
         ...
         -- battery_widget(),
            ...
            --theme.fs.widget,
            orange_arrl_pre,
            wibox.container.background(wibox.container.margin(wibox.widget { theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0)), theme.orange),
            orange_arrl_post,
            -- theme.volume.widget,
            -- pink_arrl_pre,
            -- bat,
            wibox.container.background(wibox.container.margin(wibox.widget { bat, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0)), theme.pink),
            pink_arrl_post,
            wibox.container.background(wibox.container.margin(wibox.widget { clock, layout = wibox.layout.align.horizontal }, dpi(0), dpi(0)), theme.red),
            -- clock,
            red_arrl_post,
            -- mytextclock,
        },
