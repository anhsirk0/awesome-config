...
local globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w",
        function ()
            awful.spawn("rofi -show window -theme " .. home .. ".config/rofi/themes/winmode")
        end,
...
-- my_shortcuts {{
    ...
    awful.key({ modkey,    }, "s", function () awful.spawn(home .. ".config/myshell/scripts/add_song") end,
    ...
    awful.key({ modkey,   }, "v", function () awful.spawn(home .. ".config/rofi/helper/sound_launcher.sh") end,
    ...
    awful.key({ modkey, altkey  }, "b", function () awful.spawn(home .. ".config/rofi/brave/launcher.sh") end,
    ...
    awful.key({                   }, "Print", function () awful.spawn(home .. ".config/myshell/scripts/full_screenshot")   end,
              {description = "capture a screenshot", group = "screenshot"}),

    awful.key({"Control"          }, "Print", function () awful.spawn(home .. ".config/myshell/scripts/window_screenshot")   end,
              {description = "capture a screenshot of active window", group = "screenshot"}),

    awful.key({"Shift"            }, "Print", function () awful.spawn(home .. ".config/myshell/scripts/area_screenshot")   end,
